...
export type BentoProject = (typeof projects)[number];
...
const labels = {
  NL: { problem: 'Het probleem', implementation: 'Mijn implementatie', highlights: 'Technische highlights', stack: 'Technologie', demo: 'Bekijk demo', private: 'privé', image: 'Projectpreview' },
  EN: { problem: 'The problem', implementation: 'My implementation', highlights: 'Technical highlights', stack: 'Technology', demo: 'View demo', private: 'private', image: 'Project preview' },
  DE: { problem: 'Das Problem', implementation: 'Meine Umsetzung', highlights: 'Technische Highlights', stack: 'Technologie', demo: 'Demo ansehen', private: 'privat', image: 'Projektvorschau' },
};
export function BentoProjectDetails({ project }: { project: BentoProject }) {
  ...
  return <div className="bento-project-details">
    <header><ProjectMark project={project} /><h2 className="font-display">{project.name}</h2></header>
    ...
    <section><h3>{text.stack}</h3><p>{project.stack.join(' · ')}</p></section>
  </div>;
}
