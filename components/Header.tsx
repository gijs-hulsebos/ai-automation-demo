                ...
                <div key={i} aria-hidden={i === 1 ? true : undefined} data-tech-track={i} className="flex items-center gap-x-10 pr-10 shrink-0">
                  {carouselTechnologies.map(name => (
                    <div key={name} className="flex items-center justify-center gap-2 shrink-0">
                      {name === 'Claude' ? <span className="claude-carousel-logo" aria-hidden="true"><Image src="https://gijshulsebos-media.ai-automation-workflow-demo.workers.dev/tech/claude-generated.716cf5d4de53ade9.png" alt="" width={1536} height={1024} unoptimized loading="eager" /></span> : name === 'Higgsfield' ? <span className="higgsfield-carousel-logo" aria-hidden="true"><Image src="https://gijshulsebos-media.ai-automation-workflow-demo.workers.dev/tech/higgsfield-generated.29f7ffa0277e3ac7.png" alt="" width={1536} height={1024} unoptimized loading="eager" /></span> : techIcons[name] ? <Image src={name === 'Remotion' ? '/tech/remotion-mark.svg' : techIcons[name]} alt="" width={20} height={20}
