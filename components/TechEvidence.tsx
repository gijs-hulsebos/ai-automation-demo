...
export default function TechEvidence({records,lang}:{records:EvidenceRecord[];lang:'NL'|'EN'|'DE'}){
 ...
 return <div className="tech-view">
  ...
  <p className="tech-method">{nl?'Elke as is een technologiegebied. Projectinhoud, cursusmodules en expliciete tools bepalen de koppeling. Elke bron telt per gebied één keer. De wortelschaal toont werkelijke aantallen op de ringen.':'Each axis is a technology area. Project content, course modules and explicit tools determine attribution. Each source counts once per area. The square-root scale labels actual counts on the rings.'}</p>
 </div>;
}
