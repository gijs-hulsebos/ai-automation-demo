...
export async function GET() {
  ...
  try {
    ...
    if (url.protocol !== 'https:' || url.pathname !== '/api/public/learning-report') throw new Error('Invalid public endpoint');
    ...
    if (data !== null && (data.schemaVersion !== 1 || !Array.isArray(data.learningTracks) || !data.summary)) throw new Error('Invalid public data');
